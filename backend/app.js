...
app.get("/add-review", (req, res) => {
  const review = new ModReview({
    ...
    yearTaken: "Y1S2",
    description:
      "5 tutorials in total. There are no exams but just CAs which are reflection essays.",
    review:
      "I did not learn anything from this module. I reflective essays weightage was 20% but you can only get 10% OR 20%.",
...
app.listen(3001, () => {
  console.log("nodejs listening on port 3001");
});
